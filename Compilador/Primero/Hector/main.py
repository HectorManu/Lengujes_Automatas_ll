...
class Ventana:
    ...
    def mostrar_lexematipo(self):
        ...
        self.sinvacio1 = [
            elemento for elemento in self.arreglosinespacios if elemento != ""]
        self.sinvacio = [
            elemento for elemento in self.sinvacio1 if elemento != '\n']
        ...
        for i, tipo in enumerate(self.sinrepeticion):
            tabla.insert('', 'end', text=i, values=(
                tipo.strip(), sinrepeticion2[i].strip()))
    ...
    def identificar_errores(self):
        ...
        tabla.insert(parent='', index=0, iid=0,
                     text='error', values=('uno', 'dos'))
